...
test("Ops summary keeps primary telemetry server-side while Staff stays free of queue diagnostics", () => {
  ...
  assert.doesNotMatch(ui, /Częściowa diagnostyka kolejek|deadDeliveries|deadOutbox/)
})
