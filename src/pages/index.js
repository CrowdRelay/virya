...
const musicGroupSchema = JSON.stringify({
    ...
    "member": [
        { "@type": "OrganizationRole", "member": { "@type": "Person", "name": "Wojciech Bator" }, "roleName": "Guitar" },
        { "@type": "OrganizationRole", "member": { "@type": "Person", "name": "Marek Bienias" }, "roleName": "Vocals" },
        { "@type": "OrganizationRole", "member": { "@type": "Person", "name": "Jakub D\u0105browski" }, "roleName": "Drums" },
        { "@type": "OrganizationRole", "member": { "@type": "Person", "name": "Lubomyr Kosakovsky" }, "roleName": "Bass" }
    ],
    "sameAs": [
...
export const Head = () => (
    <>
        <link rel="preload" as="image" href="/rise.webp" type="image/webp" fetchPriority="high" />
