...
export default function BackendLoader({
  ...
  return (
    <div
      ...
      class={
        overlay
          ? "absolute inset-0 z-20 flex items-center justify-center rounded-xl bg-zinc-950/70 p-6 backdrop-blur-[2px]"
          : "flex min-h-20 items-center justify-center rounded-lg border border-white/10 bg-black/30 p-5"
      }
    >
