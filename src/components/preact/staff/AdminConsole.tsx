...
const formFromOverview = (overview: TicketingOverview): TicketForm => ({
  ...
  vatRateBasisPoints: String(overview.sale.vat_rate_basis_points),
  ...
  async function save(event: SubmitEvent) {
    ...
    try {
      const payload = {
        ...
        vat_rate_basis_points: Number(form.vatRateBasisPoints),
