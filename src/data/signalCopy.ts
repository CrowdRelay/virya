...
export const SIGNAL_COPY: Record<Lang, SignalCopy> = {
  ...
  pl: {
    ...
    hero: {
      eyebrow: "VIRYA // SIGNAL",
      heading: "Jeden sygnał. Cały świat Viryi.",
      body:
        "Powiedz, skąd jesteś, odkrywaj dropy AREA, odblokowuj nagrody, obserwuj koncerty i wciągaj znajomych do sygnału. Muzyka pozostaje centrum — system sprawia, że uczestnictwo daje więcej.",
    ...
    promise: {
      ...
      heading: "Od słuchacza do części historii",
      body:
        "Virya Signal łączy muzykę, mapę miast, nagrody, merch i koncerty bez zamieniania strony w ciężką aplikację.",
      steps: [
        {
          number: "01",
          title: "Wybierz miasto",
          body: "Dołącz do własnej społeczności Viryi i pokaż nam, gdzie sygnał jest najmocniejszy.",
          href: "#join-signal",
          cta: "Dołącz",
        },
        {
          number: "02",
          title: "Graj w AREA",
          body: "Znajduj aktywne dropy, odzyskuj kolekcjonerskie transmisje i zdobywaj AREA Credits.",
          href: "/pl/area/",
          cta: "Otwórz mapę",
        },
        {
          number: "03",
          title: "Odblokuj merch",
          body: "Zamieniaj AREA Credits i progi poleceń na realne korzyści w sklepie Viryi.",
          href: "/pl/merch/",
          cta: "Otwórz sklep",
        },
        {
    ...
    form: {
      eyebrow: "Aktywacja",
      heading: "Uruchom swój Virya Signal",
      body:
        "Jeden e-mail i jedno miasto. Używamy ich do istotnych informacji od Viryi, nie do generycznego spamu.",
      email: "E-mail",
    ...
    events: {
      eyebrow: "Warstwa live",
      heading: "Obserwuj kolejne transmisje",
      body:
        "Otwórz stronę koncertu, zapisz datę i zgłoś zainteresowanie. Wybrane wydarzenia mogą mieć też ograniczone pule wejściówek.",
    ...
    area: {
      eyebrow: "Warstwa gry",
      heading: "AREA zamienia uwagę w prawdziwą przygodę",
      body:
        "Signal daje ciągłość. AREA daje polowanie: fizyczne lokalizacje, kolekcjonerskie wersy, postęp społeczności i nagrody prowadzące prosto do sklepu.",
      cta: "Wejdź do AREA",
