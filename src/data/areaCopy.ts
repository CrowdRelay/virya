...
export const AREA_COPY = {
  en: {
    ...
    claim: {
      ...
      inlineSignupPrompt: "Enter your email to activate Signal and claim this drop. We'll send you a confirmation link.",
      inlineSignupPlaceholder: "your@email.com",
      inlineSignupSubmit: "Activate & claim",
      inlineSignupSending: "Sending…",
      inlineSignupSent: "Sent! Check your email to confirm. Your claim will complete when you return.",
      inlineSignupError: "Something went wrong. Try again or open your player profile.",
    },
    profile: {
  ...
  pl: {
    ...
    claim: {
      ...
      inlineSignupPrompt: "Wpisz e-mail, aby aktywować Sygnał i zablokować ten drop. Wyślemy Ci link potwierdzający.",
      inlineSignupPlaceholder: "twoj@email.com",
      inlineSignupSubmit: "Aktywuj i zablokuj",
      inlineSignupSending: "Wysyłam…",
      inlineSignupSent: "Wysłane! Sprawdź maila, aby potwierdzić. Zablokowanie dokończy się automatycznie, gdy wrócisz.",
      inlineSignupError: "Coś poszło nie tak. Spróbuj ponownie albo otwórz profil gracza.",
    },
    profile: {
