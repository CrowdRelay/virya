...
```text
CROWDRELAY_STAFF_API_KEY=<same value as CrowdRelay CROWDRELAY_STAFF_API_KEY>
```
...
```json
{
  ...
  "role": "staff",
  "bearerToken": "<CROWDRELAY_STAFF_API_KEY>",
...
- rotate `CROWDRELAY_STAFF_API_KEY` in CrowdRelay and Netlify to revoke all paired staff devices.
